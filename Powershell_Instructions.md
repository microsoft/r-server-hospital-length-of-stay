...
1.  When prompted, enter the servername, username, and password for your SQL 2016 or SQL 2017 server. Use the username and password of the user who will be creating the solution. (The Python version of this solution is only available if you are using a SQL 2017 server.)
