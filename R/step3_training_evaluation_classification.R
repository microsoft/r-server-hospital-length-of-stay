...
## 2. Train classification model Random Forest (RF) on LoS_Train, and save it to SQL. 
## 3. Score RF and GBT on LoS_Test.

## Input : Data set LoS
## Output: Random forest model saved to SQL. 
...
##	Specify the variables to keep for the training and Compute the stratification sampling rates. 
